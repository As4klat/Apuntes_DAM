...
private void btRegistrarActionPerformed(java.awt.event.ActionEvent evt) {										
  ...
  //  DAOVehiculoImpl.getInstance().insertarVehiculo(new Vehiculo(txtMatricula.getText(), ))
    if(!Controller.insertarVehiculo(this, tablaVehiculos)){
        JOptionPane.showMessageDialog(jfr, "No puede haber dos matriculas iguales");
    }
...
private void btLeerActionPerformed(ActionEvent evt) {
    Controller.leerVehiculo(this, tablaVehiculos);
}

private void btEliminarActionPerformed(ActionEvent evt) {
    Controller.eliminarVehiculo(this, tablaVehiculos);
}

private void btModificarActionPerformed(ActionEvent evt) {
    if(!Controller.modificarVehiculo(this, tablaVehiculos)){
        JOptionPane.showMessageDialog(jfr, "No puede haber dos matriculas iguales");
    }
}
